    ...
    for ti2 in ti2l:
        for lte in ltel:
            ...
            abundances_all = [["450", "460", "480", "490", "500"], ["460", "470", "490", "500"],
                              ...
                              ["450", "460", "480", "490", "510"], ["460", "470", "490", "500"], ["250", "270", "280", "300"], ["290", "310", "320", "330"], ["210", "230", "250", "270"],
                              ["265", "270", "275", "280", "290"]]
...
5490.7         0.000     0.000"""
    ...
    5490.7         0.000     0.000"""
            ...
            for abundance in abundances_string:
                ...
                #if star == "chris" or star == "122563" or star == "140283" or star == "sun" or star == "84":
                ...
                for lower_val, upper_val in zip(lower_val, upper_val):
                    ...
                    if lines[loop_count] == 3761.3:
                        lower_val -=0.2
                        upper_val+=0.2
                    if lines[loop_count] == 3981.8:
                        upper_val-=0.11
                    if lines[loop_count] == 3277.0:
                        lower_val+=0.10
                    if lines[loop_count] == 3477.2:
                        lower_val+=0.05
                    if lines[loop_count] == 3982.0:
                        lower_val+=0.10

                    if lines[loop_count] == 4798.6:
                        lower_val -= 0.05
                    if lines[loop_count] == 5739.5:
                        upper_val += 0.8
                    if lines[loop_count] == 8692.3:
                        upper_val += 0.05
